                    ...
                    let tb_listLink = $('#tb_listLink').DataTable({
                        ...
                        columnDefs: [{
                            ...
                            },
                            {
                                ...
                                data: null,
                                render: (data) => `
                                <button type="button" class="btn btn-warning btn-sm edite-list-link">
                                    <i class="bi bi-pencil-square"></i>
                                    <span>แก้ไข</span>
                                </button>
                                <button type="button" class="btn btn-danger btn-sm del-list-link">
                        ...
                        initComplete: function(settings, json) {
                            ...
                            updateTableWrapper();
                            const table = $('#tb_listLink').DataTable();

                            // ปุ่ม Edit
                            $('#tb_listLink').on('click', '.edite-list-link', function(e) {
                                e.preventDefault();
                            ...
                            // ปุ่ม Delete
                            $('#tb_listLink').on('click', '.del-list-link', function(e) {
                                e.preventDefault();
                                const rowData = table.row($(this).closest('tr')).data();
                                console.log('Delete Click:', rowData);
                            });
