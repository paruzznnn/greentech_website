...
$("#submitEditnews").on("click", function (event) {
    ...
    // console.log("👉 Start submitEditnews handler");
    ...
    if (contentFromEditor) {
        ...
        formData.set("news_content", finalContent);
    ...
    if (!$("#news_subject").val().trim()) {
        $("#news_subject").addClass("is-invalid");
        console.error("❌ Validation failed: news_subject is empty");
        return;
    }
    if (!$("#news_description").val().trim()) {
        $("#news_description").addClass("is-invalid");
        console.error("❌ Validation failed: news_description is empty");
        return;
    }
    if (!finalContent.trim()) {
        alertError("Please fill in content information.");
        console.error("❌ Validation failed: news_content is empty");
        return;
    }

    formData.set("news_subject", $("#news_subject").val());
    formData.set("news_description", $("#news_description").val());

    // console.log("📤 Form data prepared:", {
    //     news_id: $("#news_id").val(),
    //     news_subject: $("#news_subject").val(),
    //     news_description: $("#news_description").val(),
    //     news_content: finalContent,
