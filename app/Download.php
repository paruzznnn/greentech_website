...
<div class="container my-5" style="color: #555; max-width: 90%;">
    <h4><i class="bi bi-pc-display-horizontal text-danger"></i> <span class="text-danger"><?= getTextByLang('windows_title') ?></span></h4>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                <td>
                    <?= getTextByLang('windows_download_text1') ?><br>
                    <a href="https://www.insul.co.nz/media/45381/insul10-setup-signed.msi" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('windows_download_text2') ?><br>
                    <a href="https://www.insul.co.nz/media/45381/insul10-setup-signed.msi" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
        </tbody>
    ...
    <h4><i class="bi bi-apple text-danger"></i> <span class="text-danger"><?= getTextByLang('mac_title') ?></span></h4>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <a href="https://www.insul.co.nz/media/45384/Insul1006.dmg" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('mac_download_text2') ?><br>
                    <a href="https://www.insul.co.nz/media/45387/Insul1006HFS.dmg" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <h4><i class="bi bi-apple text-danger"></i> <span class="text-danger"><?= getTextByLang('hasp_drivers_title') ?></span></h4>
    <table class="table table-bordered">
        <thead>
            <tr>
                <th style="color: #555;"><?= getTextByLang('table_header_file') ?></th>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/HASPUserSetup.zip" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('driver_mac') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Sentinel_Runtime.zip" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('update_instructions') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Instructions-for-Upgrading-the-key-RemoteUtility.pdf" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('remote_utility') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/MDARemoteUpDateUtilityV6-3.zip" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
        </tbody>
    </table>
    
    <h4><i class="bi bi-file-earmark-text text-danger"></i> <span class="text-danger"><?= getTextByLang('documents_title') ?></span></h4>
    <table class="table table-bordered">
        <thead>
            <tr>
                <th style="color: #555;"><?= getTextByLang('table_header_file') ?></th>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Insul_notes.pdf" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('doc_manual') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Insul-Manual-2017-word-version.pdf" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('doc_trial_install') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Install-Instructions-for-INSUL-TrialVersion.pdf" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('doc_single_user_install_win') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Install-Instructions-for-v90-From-Web.pdf" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('doc_single_user_install_mac') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Install-Instructions-for-v90-From-Web-OSX-.pdf" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('doc_upgrade_8_to_9') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Instructions-for-Upgrading-from-Version-8-to-9.pdf" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('doc_network_install_win') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/InstallInstructionsForNetworkVersion9-0.pdf" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
        </tbody>
    </table>
    
    <h4><i class="bi bi-apple text-danger"></i> <span class="text-danger"><?= getTextByLang('previous_versions_title') ?></span></h4>
    <table class="table table-bordered">
        <thead>
            <tr>
                <th style="color: #555;"><?= getTextByLang('table_header_file') ?></th>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Update90r23-1.zip" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
            <tr>
                <td>
                    <?= getTextByLang('prev_mac_hfs') ?><br>
                    <a href="https://www.trandar.com/wp-content/uploads/2021/05/Insul9022HFS.zip" class="text-primary"><?= getTextByLang('download_link') ?></a>
                </td>
            </tr>
        </tbody>
    </table>
