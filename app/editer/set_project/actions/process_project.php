...
// print_r($_POST); exit;
        ...
        if (isset($news_array)) {
            ...
            $news_subject = $news_array['project_subject'];
            $news_description = $news_array['project_description'];

            $news_content = mb_convert_encoding($news_array['project_content'], 'UTF-8', 'auto');
        ...
        if (!empty($news_array['project_id'])) {
