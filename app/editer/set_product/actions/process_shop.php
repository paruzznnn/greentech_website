...
// print_r($_POST); exit;
        ...
        if (isset($news_array)) {
            ...
            $news_subject = $news_array['shop_subject'];
            $news_description = $news_array['shop_description'];

            $news_content = mb_convert_encoding($news_array['shop_content'], 'UTF-8', 'auto');
