...
// print_r($_POST); exit;
        ...
        if (isset($news_array)) {
            ...
            $news_subject = $news_array['idia_subject'];
            $news_description = $news_array['idia_description'];

            $news_content = mb_convert_encoding($news_array['idia_content'], 'UTF-8', 'auto');
