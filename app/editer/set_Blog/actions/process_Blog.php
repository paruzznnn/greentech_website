...
// print_r($_POST); exit;
        ...
        if (isset($news_array)) {
            ...
            $news_subject = $news_array['Blog_subject'];
            $news_description = $news_array['Blog_description'];

            $news_content = mb_convert_encoding($news_array['Blog_content'], 'UTF-8', 'auto');
